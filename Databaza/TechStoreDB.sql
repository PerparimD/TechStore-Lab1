...
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Llogaria', 'User', 'test@rmail.com', 'user', '$2y$10$juI.BOzWW1giyHJ1D9.Hje.mOPSGAFDgB..C9ACJkSZ1cKZchCTPa', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Llogaria', 'Adminit', 'admin@gmail.com', 'admin', '$2y$10$bWkaCvfxf/k4bZMSbP2rbOHEk7NTOx9UmBjSrpOYnyMACCEq99rNa', 2);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Llogaria', 'Menagjimit', 'menagjim@gmail.com', 'menagjim', '$2y$10$eepxMAnYPktEBl0dWRhOU.oC7S2FO2GrlxTOJuTk8YhUFNcIIRYcy', 1);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Filan', 'Fisteku', 'filan@gmail.com', 'filani', '$2y$10$fdiuTd/R7hN.oKAaZHycoeVd.cIgIJiNriOjMlyvOhnO6xFKwGAn.', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Perparim', 'Dardhishta', 'perparim.dardhishta@gmail.com', 'perparimd', '$2y$10$X/IwYW7TA.iSqgOKNDEoaejZUUn1Qv7.Xt4.ZnWYFPYDyrrNQPClC', 2);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Rilind', 'Kyçyku', 'r.kycyku.12@gmail.com', 'rkycyku', '$2y$10$RU7djgxAPPVNRR1A0uIOZuELNOsTGryD37nm4u3Mcc/5nWAfkp3m2', 2);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Filane', 'Fisteku', 'filane.fistekuu@hotmail.com', 'filane', '$2y$10$cCLaFjhVB84TiwYrbPsuFObh3VN/r62GstzGcMcuW3InIQIEeu3cK', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Arber', 'Krasniqi', 'arberk@gmail.com', 'arberk', '$2y$10$cPSrPpH.gX/F/YuhkUbzveGNPYCPFLT.ZvVLhqxSYhSWsXy462vYC', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Drita', 'Gashi', 'dritag@hotmail.com', 'dritag', '$2y$10$BcFj6o3kdwyaQUNSU6zxdOqpFwcS291SzyA8weEj8cWJA465qvByK', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Lirim', 'Shala', 'lirimsh@yahoo.com', 'lirimsh', '$2y$10$MQq.GzmgUpIc04m6qRL2fuCG6Pbr9v.DvAe82p3bRt2GWWooRnU6S', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Elona', 'Qorraj', 'elonaq@outlook.com', 'elonaq', '$2y$10$xrOGFueQq4xM3SMYPmaM7eXy5zNgZUu70alQJUEOsdLfaBgU6kkB2', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Besmir', 'Sula', 'besmirs@protonmail.com', 'besmirs', '$2y$10$jW9nYJ5bLVXQRVonUAWEdeS8GH2BApaYgpnwbHKFxXsnh9uArFkya', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Flaka', 'Krasniqi', 'flakak@icloud.com', 'flakak', '$2y$10$AOpIj4UlUcaX46NVrKNl5OFjryUxyczzlk0rz6NuDTuu3nFOP2jlC', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Labinot', 'Gashi', 'labig@live.com', 'labinotg', '$2y$10$005CoHNvo74QkunTxvbMieBpksoA3XI80YHyk/UAnJ/N3P/z5HYZi', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Vesa', 'Shala', 'vesas@ymail.com', 'vesash', '$2y$10$lgJP5oGdRLFVCevycDXTk.RrJTENht9AD2UC9p2fIz2nHml/WgC7.', 1);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Ardian', 'Qorraj', 'ardianq@aol.com', 'ardianq', '$2y$10$aX0hjrVGqnmabaoIIG17pOJeiSrBqxa3Rak6LuJX6gpZkrEMAtR.C', 0);
INSERT INTO [dbo].[Perdoruesi] ([emri], [mbimeri], [email], [username], [userPW], [aksesi]) VALUES ('Edona', 'Sula', 'edonas@rocketmail.com', 'edonas', '$2y$10$ttnZDkeekdeFQbz/YcV3BO5FpYwsDn24QTlI3LR6.0CHzWkC4ydui', 1);
