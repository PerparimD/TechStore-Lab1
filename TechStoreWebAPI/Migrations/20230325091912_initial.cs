        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    llojiKategoris = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
                    pershkrimiKategoris = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Kategori__AC39DE2A718DB0F6", x => x.kategoriaID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    kompaniaID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    emriKompanis = table.Column<string>(type: "varchar(30)", unicode: false, maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Kompania__2026D74D2CBCA899", x => x.kompaniaID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Perdorue__CB9A1CDFFF440186", x => x.userID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    qmimiProduktit = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    kompaniaID = table.Column<int>(type: "int", nullable: true),
                    kategoriaID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Produkti__76A3DFCF401E13B1", x => x.produktiID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ContactF__0E3F7CF3896D6952", x => x.mesazhiID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idPorosia = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    totaliPorosis = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Porosit__A9F27D2AA2D4B4AE", x => x.idPorosia);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    qmimiZbritjes = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    idProdukti = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__KodiZbri__25A8748F581632B6", x => x.kodi);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idDetajet = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    qmimiTotal = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TeDhenat__494F491F08848686", x => x.idDetajet);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Perdorue__F3DBC5721B2F0C29",
                table: "Perdoruesi",
                column: "username",
                unique: true);
